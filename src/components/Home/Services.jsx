      ...
      <div className="w-full px-6 lg:px-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {modules.map((item, index) => (
            <div 
              key={index} 
              className="group p-8 bg-slate-50 rounded-[2rem] border  border-gray-200 hover:border-[#31b8c6]/20 hover:bg-white hover:shadow-xl hover:shadow-slate-200/40 transition-all duration-300 flex flex-col justify-between min-h-[280px]"
            >
              <div>
                {/* Header: Icon and Tag */}
